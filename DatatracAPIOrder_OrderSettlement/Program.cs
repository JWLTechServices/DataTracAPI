                                        ...
                                        if (CustomerName == "BBB")
                                        {
                                            ...
                                            foreach (DataTable curDatatable in splitdtBBB)
                                            {
                                                ...
                                                foreach (DataRow drow in datatable1.Rows)
                                                {
                                                    ...
                                                    if (drow.Table.Columns.Contains("Store Code"))
                                                    {
                                                        if (!string.IsNullOrEmpty(Convert.ToString(drow["Store Code"])))
                                                        {
                                                            objOrder.pickup_name = Convert.ToString(drow["Store Code"]);
                                                        }
                                                    }
